<?php get_header(); ?>
    ...
    <!-- MAIN CONTENT -->
    <div class="site-content <?php if($is_banner) echo 'sc-static'; else echo 'sc-no-banner';?>" id="siteContent">
        ...
        <div class="row brc-wrapper hide-for-small-only">
            <div class="medium-12 column">
                <ul class="breadcrumbs brc-list">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Restaurants</a></li>
                    <li><a href="#">Śląskie</a></li>
                    <li><a href="#">Knurów</a></li>
                    <li class="current"><a href="#">Kawiarnia Weranda</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row" style="text-align: justify;  padding-top: 3%;">
                            ...
                            <div class="medium-4 column">
                                ...
                                <table class="rst-address-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $restaurant_fields['www'] ?></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <div class="large-4 column recipe-side">
                ...
                <div class="row">
                    <div class="medium-12 column">
                        <h3 style="font-weight:500; padding-bottom: 10px;">Oceń restaurację:</h3>
                        <div class="row">
                            <div class="medium-10 columns medium-centered">
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star"></i></div>
                                <div class="small-1 column"><i class="fa fa-star-o"></i></div>
                                <div class="small-1 column"><i class="fa fa-star-o"></i></div>
                                <div class="small-1 column"><i class="fa fa-star-o"></i></div>
                                <div class="small-1 column"><i class="fa fa-star-o"></i></div>
                            </div>
